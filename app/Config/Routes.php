...
$routes->get('scan/(:any)', 'Scan::index');
$routes->get('scan', 'Scan::index');
$routes->post('scan/cek', 'Scan::cekKode');


$routes->get('admin/guru/download-template', 'Admin\DataGuru::downloadTemplate');
$routes->get('admin/guru/import', 'Admin\DataGuru::importCSV');
$routes->post('admin/guru/import', 'Admin\DataGuru::importCSV');
// Config/Routes.php or wherever your routes are defined
$routes->get('admin/guru/download-template', 'Admin\DataGuru::downloadTemplate');
$routes->get('admin/guru/import', 'Admin\DataGuru::importCSV');
$routes->post('admin/guru/import', 'Admin\DataGuru::importCSV');
$routes->get('admin/guru/import', 'Admin\DataGuru::importCSV');

$routes->post('admin/guru/generateCSVObjectPost', 'Admin\DataGuru::generateCSVObjectPost');
$routes->post('admin/guru/importCSVItemPost', 'Admin\DataGuru::importCSVItemPost');
$routes->get('admin/guru/download-template', 'Admin\DataGuru::downloadTemplate');
...
$routes->group('admin', function (RouteCollection $routes) {
   ...
   $routes->get('dashboard', 'Admin\Dashboard::index');
      ...
      // Attendance Settings
      $routes->get('attendance-settings', 'Admin\AttendanceSettings::index');
      $routes->post('attendance-settings/update', 'Admin\AttendanceSettings::update');
   ...
   // super admin lihat data petugas
