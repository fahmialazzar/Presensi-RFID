                ...
                <form action="<?= base_url('admin/siswa/create'); ?>" method="post">
                            ...
                            <select class="form-control-custom <?= $validation->getError('id_kelas') ? 'is-invalid' : ''; ?>" 
                                ...
                                <?php foreach ($kelas as $value) : ?>
                                    <option value="<?= $value['id_kelas']; ?>" 
                                            <?= old('id_kelas') ?? $oldInput['id_kelas'] ?? '' == $value['id_kelas'] ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="date" 
                               ...
                               name="tgl_lahir" 
                               value="<?= old('tgl_lahir') ?? $oldInput['tgl_lahir'] ?? '' ?>">
                        <div class="invalid-feedback-custom">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="text" 
                               ...
                               name="unique_code" 
                               value="<?= old('unique_code') ?? $oldInput['unique_code'] ?? '' ?>"
                    ...
                    <div class="form-group-custom">
                        ...
                        <textarea id="alamat" 
                                  ...
                                  placeholder="Masukkan alamat lengkap siswa"><?= old('alamat') ?? $oldInput['alamat'] ?? '' ?></textarea>
                        <div class="invalid-feedback-custom">
