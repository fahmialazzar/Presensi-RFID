...
<div class="petugas-container">
    <style>
        ...
        .action-btn-edit:hover {
            background-color: var(--petugas-primary);
            color: white;
            transform: translateY(-2px);
        ...
        .action-btn-view {
            ...
            color: var(--petugas-secondary);
        }
        
        .action-btn-view:hover {
            background-color: var(--petugas-secondary);
            color: white;
            transform: translateY(-2px);
            ...
            <div class="card-header-custom">
                <div class="header-content">
                    ...
                    <div class="action-buttons">
                        <a class="btn-custom" id="tabBtn" onclick="removeHover();" href="<?= base_url('admin/petugas/register'); ?>">
                            <i class="material-icons">add</i>
                            <span>Tambah Petugas</span>
                        </a>
                        <a class="btn-custom" id="refreshBtn" onclick="getDataPetugas()" href="#" data-toggle="tab">
   ...
   function getDataPetugas() {
      jQuery.ajax({
         ...
         success: function(response, status, xhr) {
            ...
            $('html, body').animate({
               scrollTop: $("#dataPetugas").offset().top - 100
            }, 500);
         },
