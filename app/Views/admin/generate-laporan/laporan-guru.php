...
<style>
   ...
   table.attendance-table td.nama-guru {
      text-align: left;
      padding-left: 8px;
      min-width: 200px;
      max-width: 220px;
...
<table class="attendance-table">
   ...
   <tbody>
      ...
      <?php foreach ($listGuru as $guru) : ?>
         ...
         <tr>
            <td class="no"><?= $i + 1; ?></td>
            <td class="nama-guru"><?= $guru['nama_guru']; ?></td>
...
<div class="summary-section">
   <table class="summary-table">
      <tr>
         <td>Jumlah Guru</td>
         <td>: <?= count($listGuru); ?> guru</td>
      </tr>
      <tr>
         <td>Laki-laki</td>
         <td>: <?= $jumlahGuru['laki']; ?> guru</td>
      </tr>
      <tr>
         <td>Perempuan</td>
         <td>: <?= $jumlahGuru['perempuan']; ?> guru</td>
      </tr>
   </table>
</div>
